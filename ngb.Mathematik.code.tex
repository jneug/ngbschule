...
\newcommand{\geoLinienbreite}[1][1.2pt]{\tikzset{line style/.style={line width=#1}}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                Objekte                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\NewDocumentCommand \geoText { O{} r() m } {\tkzText[fill=white,#1](#2){#3}}
...
\NewDocumentCommand \geoLaenge { O{} r() O{} m } {\tkzDrawSegment[line width=1pt,|-|,#1](#2)\tkzLabelSegment[#3](#2){#4}}
